...
set -x
# Tape initialisation
curl -X PUT "$LDPC"p01 --data-binary ' @prefix rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#> . <> rdf:first "#" ; rdf:rest <p02> . ' -Hcontent-type:text/turtle
curl -X PUT "$LDPC"p02 --data-binary ' @prefix rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#> . <> rdf:first "#" ; rdf:rest <p03> . ' -Hcontent-type:text/turtle
curl -X PUT "$LDPC"p03 --data-binary ' @prefix rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#> . <> rdf:first "1" ; rdf:rest <p04> . ' -Hcontent-type:text/turtle
curl -X PUT "$LDPC"p04 --data-binary ' @prefix rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#> . <> rdf:first "1" ; rdf:rest <p05> . ' -Hcontent-type:text/turtle
...
curl -X PUT "$LDPC"p06 --data-binary ' @prefix rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#> . <> rdf:first "#" ; rdf:rest <p07> . ' -Hcontent-type:text/turtle
curl -X PUT "$LDPC"p07 --data-binary ' @prefix rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#> . <> rdf:first "#" ; rdf:rest <p08> . ' -Hcontent-type:text/turtle
curl -X PUT "$LDPC"p08 --data-binary ' @prefix rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#> . <> rdf:first "#" ; rdf:rest <p09> . ' -Hcontent-type:text/turtle
...
curl -X PUT "$LDPC"tm1 --data-binary ' @prefix tm: <http://www.example.org/turing-machine#> . <> tm:hasInitialPosition <p03> ; tm:hasCurrentPosition <p03> ; tm:hasCurrentState <q0> .' -Hcontent-type:text/turtle
{ set +x; } 2>/dev/null
...
curl -X PUT "$LDPC"tr1 --data-binary @divisible-by-3.ttl -Hcontent-type:text/turtle
{ set +x; } 2>/dev/null
