...
# Cleanup
curl -X DELETE http://localhost:8080/rwldresources/ || exit 1

# Tape initialisation
curl -X PUT http://localhost:8080/rwldresources/p01 --data-binary ' @prefix rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#> . <> rdf:first "0" ; rdf:rest <p02> . ' -Hcontent-type:text/turtle
...
curl -X PUT http://localhost:8080/rwldresources/tr1 --data-binary @tmtransitions.ttl -Hcontent-type:text/turtle
