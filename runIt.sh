...
# Tape initialisation
curl -X PUT localhost:8080/rwldresources/p1  --data-binary ' @prefix rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#> . <> rdf:first "0" ; rdf:rest <p2>  . ' -Hcontent-type:text/turtle
curl -X PUT localhost:8080/rwldresources/p2  --data-binary ' @prefix rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#> . <> rdf:first "0" ; rdf:rest <p3>  . ' -Hcontent-type:text/turtle
curl -X PUT localhost:8080/rwldresources/p3  --data-binary ' @prefix rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#> . <> rdf:first "0" ; rdf:rest <p4>  . ' -Hcontent-type:text/turtle
...
curl -X PUT localhost:8080/rwldresources/p6  --data-binary ' @prefix rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#> . <> rdf:first "0" ; rdf:rest <p7>  . ' -Hcontent-type:text/turtle
curl -X PUT localhost:8080/rwldresources/p7  --data-binary ' @prefix rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#> . <> rdf:first "0" ; rdf:rest <p8>  . ' -Hcontent-type:text/turtle
curl -X PUT localhost:8080/rwldresources/p8  --data-binary ' @prefix rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#> . <> rdf:first "0" ; rdf:rest <p9>  . ' -Hcontent-type:text/turtle
curl -X PUT localhost:8080/rwldresources/p9  --data-binary ' @prefix rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#> . <> rdf:first "0" ; rdf:rest <p10> . ' -Hcontent-type:text/turtle
...
curl -X PUT localhost:8080/rwldresources/tm1 --data-binary ' @prefix tm: <http://www.example.org/turing-machine#> . <> tm:hasInitialPosition <p9> ; tm:hasCurrentPosition <p9> ; tm:hasCurrentState <A> .' -Hcontent-type:text/turtle
